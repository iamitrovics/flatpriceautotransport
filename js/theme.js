...
(function ($) {
  jQuery(document).ready(function () {
    ...
    $("#faq-accordion .faq-box > h4").on("click", function (e) {
      if ($(this).hasClass("active")) {
        $(this).removeClass("active");
        $(this).siblings("#faq-accordion .faq-box div").slideUp(200);
      } else {
        $("#faq-accordion .faq-box > h4").removeClass("active");
        $(this).addClass("active");
        $("#faq-accordion .faq-box div").slideUp(200);
        $(this).siblings("#faq-accordion .faq-box div").slideDown(200);
      }
    ...
    jQuery(document).ready(function ($) {
      var $timeline_block = $('.cd-timeline-block'); //hide timeline blocks which are outside the viewport
      ...
      $(".date-picker-input").attr("autocomplete", "off"); //on scolling, show/animate timeline blocks when enter the viewport
